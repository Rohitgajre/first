...
class App1Principle(models.Model):
...
class Person(models.Model):
    ...
    date_joins = models.DateTimeField(blank=True, null=True)
...
class SubjectStudent(models.Model):
    id = models.BigAutoField(primary_key=True)
    subjects = models.ForeignKey(Subject, models.DO_NOTHING)
    student = models.ForeignKey(Student, models.DO_NOTHING)

    class Meta:
        managed = False
        db_table = 'subject_student'
        unique_together = (('subjects', 'student'),)
